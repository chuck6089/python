...
aperture_size = 3  #aperture diameter in mm
...
clearimage = convert2img(cleardata[0][1])
...
center_m_dut = np.mean(crosshair_coordinates[:,0]) + 12     #use crosshair coordinates to find the center of checkboard pattern
center_n_dut = np.mean(crosshair_coordinates[:,1]) - 7
...
slbcheckerdata  = readXYZ_radiant(slbpath, colorword + ' Pos 0deg')
slbcheckerimage = convert2img(slbcheckerdata[0][1])
slbnegcheckerdata = readXYZ_radiant(slbpath, colorword + ' Neg 0deg')
slbnegcheckerimage = convert2img(slbnegcheckerdata[0][1])

slbcleardata = readXYZ_radiant(slbpath, colorword + ' Solid 0deg')
slbclearimage = convert2img(slbcleardata[0][1])
...
obj.meancontrast(17, 17, squaresize_m = squaresize_m_dut, squaresize_n = squaresize_n_dut,  center_m = center_m_dut, center_n = center_n_dut)
...
obj.Radiant_efficiency(cleardata[0][1], slbcleardata[0][1], FOVx = FOVx, FOVy = FOVy, pixperdeg = pixperdeg, exposure_SLB = 1, exposure_DUT = 1,dut_center_m = center_m_dut, dut_center_n = center_n_dut ,slb_center_m = center_m_slb, slb_center_n = center_n_slb, ND_A_path = None, ND_B_path = None)
...
X_crop = cleardata[0][0][DUT_Y_crop[0]:DUT_Y_crop[1],DUT_X_crop[0]:DUT_X_crop[1]]
Y_crop = cleardata[0][1][DUT_Y_crop[0]:DUT_Y_crop[1],DUT_X_crop[0]:DUT_X_crop[1]]
Z_crop = cleardata[0][2][DUT_Y_crop[0]:DUT_Y_crop[1],DUT_X_crop[0]:DUT_X_crop[1]]
