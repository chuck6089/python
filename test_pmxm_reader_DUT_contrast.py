...
slbpath = r"X:\IQT2-Display\Devices\Lumus\Lumus_SN75010\Projector\Lumus V3_0deg\Lumus_SN75010_Projector_4mm_Lumus v3_ERD0.4_20240130_2mmCalibFile_noProjectorAperture.pmxm"  #righteye projector LN75010
slbpath = r"X:\IQT2-Display\Devices\Lumus\Lumus_SN75010\Projector\Lumus V3_0deg\Lumus_SN75010_Projector_V3_4mm_ERD0.4_NoProjectorAperture_2mmCali_20240311.pmxm"
#slbpath = r"X:\IQT2-Display\Devices\Lumus\Lumus_SN75014\Projector\Lumus_V3_0deg\Lumus_SN75014_Projector_4mm_Lumus_V3_ERD0.4_20240212_2mmCalibFile_noProjectorAperture.pmxm"  #lefteye projector LN75014
#slbpath = r"C:\Data\SLB data\Lumus_SN75010_Projector_4mm_Lumus v3_ERD0.4_20240130_2mmCalibFile_noProjectorAperture.pmxm"
...
path = r'X:\IQT2-Display\Devices\Lumus\Lumus_SN75014\SCS41\Lumus_SN75014_SCS41_2mm_Lumus_V4B_Left_Secondary_Eyebox_ERD0.8mm_NoProjectorAperture_20240405.pmxm'
...
slbdir, slbfilename = os.path.split(slbpath)
...
center_m_slb = 804 #-20 #-20 for lefteye projector LN75014
center_n_slb = 549 #-20 
#rotate = 0.5 #deg positive for counter-clockwise
rotate = 0.5 
rotate_slb = -27 + 90 #deg
#rotate_slb = 26 #deg
...
saddlepoint_size = (15,15)
detectable_saddlepoint = saddlepoint_size[1] - 0

center_m_dut_offset = 0
...
obj.SLB_contrast(saddlepoint_size[0] + 1,saddlepoint_size[1] + 1, squaresize_m = squaresize_m_slb, squaresize_n = squaresize_n_slb,  center_m = center_m_slb, center_n = center_n_slb)
#obj.meancontrast(17, 17, squaresize_m = 37.3, squaresize_n = 37.5,  center_m = 868, center_n = 648)
obj.meancontrast(saddlepoint_size[0] + 1, saddlepoint_size[1]+1, squaresize_m = squaresize_m_dut, squaresize_n = squaresize_n_dut, saddlepoint_size = saddlepoint_size, detectable_saddlepoint = detectable_saddlepoint ,  center_m = center_m_dut, center_n = center_n_dut)
...
Metrics = [
    ...
    #["Eyebox Efficiency",obj.Rad_eff * eyebox_size/(np.pi*aperture_size**2/4)]
    #["SLB_Meancontrast",obj.slb_meancontrast],
    ["Calibrated_Meancontrast(WG only)",obj.calibrated_meancontrast],
    ["ZoneA_Calibrated_Meancontrast(WG only)", obj.ZoneA_meancontrast],
    ["Raw Mean contrast(projector+WG)",obj.meancontrast],
    ["ZoneA_Raw mean contrast(projector+WG)",obj.ZoneA_meanrawcontrast],
    ["ZoneA_angular_uniformity", obj.ZoneA_uniformity],
    ["FOV_x",obj.FOV_dut_H],
    ["FOV_y",obj.FOV_dut_V]
    ]
...
SLB_Metrics = [
    ...
    ["SLB_angular_uniformity",uniformity_slb],
    ["SLB_Meancontrast",obj.slb_meancontrast],
    ["SLB_FOV_H",obj.FOV_slb_H_center],
    ["SLB_FOV_V",obj.FOV_slb_V_center],
    ]

analyzer.transpose_list_to_csv(Metrics, "Metrics.csv")
analyzer.transpose_list_to_csv(SLB_Metrics, "Metrics_SLB.csv")